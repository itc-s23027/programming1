...
### 第4章　関数
* 4.1 関数の書き方[問題](CHAPTER04/Q4_1_1.py)[問題](CHAPTER04/Q4_1_2.py)
* 4.2 キーワード引数[問題](CHAPTER04/Q4_2_1.py)[問題](CHAPTER04/Q4_2_2.py)
* 4.3 引数リスト[問題](CHAPTER04/Q4_3_1.py)[問題](CHAPTER04/Q4_3_2.py)
* 4.4 関数とスコープ
* 4.5 関数はオブジェクト
* 4.6 ラムダ式
* 4.7 関数の中の関数
